...
# import copy
# id_1_new = copy.copy(id_1)
# id_3_new = copy.copy(id_3)
# id_1 = copy.copy(id_2)
# id_2 = copy.copy(id_1_new)
# id_3 = copy.copy(id_4)
# id_4 = copy.copy(id_3_new)

# id_5_new = copy.copy(id_6)
# id_5 = copy.copy(id_6)
# id_6 = copy.copy(id_5_new)
